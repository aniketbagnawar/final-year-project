...
# packages
import pandas as pd 
from urllib.parse import urlparse,urlencode #URL related feature 
import re   #regular expreesion
from bs4 import BeautifulSoup   #ectract data from webpages
import requests #for send request to specific site
import whois    #to identify domain info
import urllib.request
from datetime import datetime
import time
import socket   #connection between to end points
from urllib.error import HTTPError
from cython.parallel import prange  #to parallel loops
