...
# packages
import pandas as pd
from urllib.parse import urlparse,urlencode #URL spliting related to urls
import re   #regular expression
from bs4 import BeautifulSoup   #easy to scrape information from web pages
import requests #Make a request to a web page
import whois    #Whois is used to identify owner of dpecific domain name
import urllib.request #Urllib.request is used to defines classes and functions which is used to access URLs
from datetime import datetime
import time #time related functions like count sec. since epoch
import socket #a way of connecting two nodes on a network
from urllib.error import HTTPError #used to handel exception
from cython.parallel import prange #This function can be used for parallel loops
...
print(extractFeat('http://www.facebook.com/'))